...
function createData(id, issue, status, assigned,category,issudate,dateresolved,userid) {
  return { id, issue, status, assigned,category,issudate,dateresolved,userid};
}

const rows = [
  createData('123','Help','Completed','ABC','abc','02-06-20','06-04-20','45')
];
