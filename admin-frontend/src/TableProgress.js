...
function createData(id, issue, status, assigned,category,priority,issudate,dateresolved,userid,comment) {
  return { id, issue, status, assigned,category,priority,issudate,dateresolved,userid,comment};
}

const rows = [
  createData('123','Help','Completed','ABC','abc','Low','02-06-20','06-04-20','45',<Addcomment/>)
];
